// Generated by npm run contracts:generate. P07–P27 sessions, provisioning, intake, locations, routing metadata, durable planning online round start and explicit current activity; P34 replay and P35 account recovery/update compatibility are locally verified; remaining operations follow their catalog lifecycle.
export interface paths {
    ...
    "/api/v1/sync/actions": {
        ...
        get?: never;
        put?: never;
        /** Replay immutable device actions independently */
        post: operations["sync.submitActions"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/sync/conflicts": {
        ...
        /** Inspect own driver received conflicts on the current phone */
        get: operations["sync.listConflicts"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        Batch: {
            actions: components["schemas"]["action-envelope.v1.schema"][];
        };
        BatchResult: {
            actionId: components["schemas"]["Uuid"];
        ...
        Recovery: {
            ...
            constraints: ("closed-workday" | "dependent-receipt" | "changed-assignment" | "changed-source" | "changed-attempt" | "not-current-owner" | "correction-not-authorized" | "unsupported-operation" | "dependent-redispatch" | "unknown-generation" | "changed-pin" | "already-adopted" | "ended-round" | "claimed-handover" | "unresolved-dependency")[];
        ...
        SyncBatch: components["schemas"]["Batch"];
        SyncBatchResult: components["schemas"]["$defs-BatchResult"];
        SyncConflicts: components["schemas"]["Conflicts"];
        SyncEntry: components["schemas"]["Entry"];
        TableCell: {
            distanceMetres: number;
            durationSeconds: number;
            /** @constant */
...
export interface operations {
    ...
    "sync.submitActions": {
        ...
        responses: {
            /** @description Per-action durable receipt is separate from business acceptance. Missing or invalid entries are not acknowledged. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["$defs-BatchResult"];
                };
            };
