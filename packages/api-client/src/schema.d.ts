// Generated by npm run contracts:generate. P07–P24 sessions, provisioning, intake, locations, routing metadata, durable planning online round start and explicit current activity; later operations remain designed.
...
export interface components {
    schemas: {
        ...
        "$defs-ArrivalCommand": components["schemas"]["action-envelope.v1.schema"] & {
            ...
            payload: components["schemas"]["Transition"];
        };
        "$defs-CommandResult": {
        ...
        BranchTransition: components["schemas"]["Transition"];
        /** @enum {string} */
        ...
        DispositionEvent: {
            transition: components["schemas"]["$defs-Transition"] & {
                /** @enum {unknown} */
                kind: "lost" | "damaged";
            };
        };
        ...
        MonitoringAttempt: components["schemas"]["Attempt"];
        ...
        "returns.schema_$defs-CommandResult": {
            request: components["schemas"]["RequestView"];
            transitions: components["schemas"]["$defs-Transition"][];
        };
        ReturnSubsetItem: components["schemas"]["SubsetItem"];
        ReturnTransition: components["schemas"]["$defs-Transition"];
