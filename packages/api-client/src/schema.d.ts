// Generated by npm run contracts:generate. P07–P18 sessions, provisioning, intake, locations, routing metadata, durable planning online round start and explicit current activity; later operations remain designed.
...
export interface components {
    schemas: {
        ...
        AllowedAction: {
            allowed: boolean;
            blocker: ("not-held" | "different-driver" | "receipt-or-disposition" | "partial-or-delivered" | "current-customer" | "result-required" | "not-deferred" | "earliest-time" | "location-required" | "capacity") | null;
            message: string | null;
        };
        /** @enum {string} */
