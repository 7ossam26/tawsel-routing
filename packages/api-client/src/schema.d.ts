// Generated by npm run contracts:generate. P07–P13 sessions, provisioning, intake, locations, routing metadata and durable planning; later operations remain designed.
...
export interface components {
    schemas: {
        ...
        ForecastMember: {
            ...
            /** @enum {unknown} */
            membership: "assigned" | "unassigned" | "excluded";
            pinRevision: number;
        ...
        Plan: {
            candidate: components["schemas"]["OptimizationResult"];
            /** Format: date-time */
            createdAt: string;
            current: boolean;
            driverId: components["schemas"]["Uuid"];
