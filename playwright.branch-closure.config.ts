...
export default defineConfig({ testDir: './tests/branch-closure-browser', workers: 1, timeout: 300000, outputDir: 'output/playwright/phase-31-results', reporter: 'list', use: { launchOptions: { slowMo: Number(process.env.TAWSEL_BROWSER_SLOW_MO ?? 0) }, baseURL: 'http://localhost:5173', viewport: { width: 390, height: 844 }, locale: 'ar-EG', timezoneId: 'Africa/Cairo', reducedMotion: 'reduce', trace: 'retain-on-failure', actionTimeout: 20000 }, webServer: [
