...
export async function generateArtifacts(bundle) {
  ...
  const types = '// Generated by npm run contracts:generate. P07–P22 sessions, provisioning, intake, locations, routing metadata, durable planning online round start and explicit current activity; later operations remain designed.\n' + astToString(await openapiTS(pathToFileURL(resolve(root, 'contracts/openapi.yaml')), { alphabetize: true }));
  const lines = [
