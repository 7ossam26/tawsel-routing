...
export async function generateArtifacts(bundle) {
  ...
  const types = '// Generated by npm run contracts:generate. P07–P14 sessions, provisioning, intake, locations, routing metadata and durable planning; later operations remain designed.\n' + astToString(await openapiTS(pathToFileURL(resolve(root, 'contracts/openapi.yaml')), { alphabetize: true }));
  const lines = [
