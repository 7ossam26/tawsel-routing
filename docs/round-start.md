...
P34 update — 25 September 2026: the [real journal barrier](ordered-replay.md#browser-coordination-and-start-barrier) now holds the native same-device lock across synchronization, fresh planning/readiness and start. Pending day-end and second-phone checks have [connected queue/HTTP/PostgreSQL evidence](phase-34-evidence.md); offline start remains unavailable. Earlier P34-future statements below are historical.
