...
التنفيذ الفعلي: **المرحلتان 01 و02 منفذتان ومتحقق منهما محليًا ضمن نطاق التأسيس؛ مواصفات المرحلة 03 مكتملة؛ ومكونات/عرض المرحلة 04 التجريبي منفذة ومتحقق منها في Chromium مع انتظار مراجعة المالك؛ المراحل 05–42 لم تبدأ، والمرحلة 05 هي التالية**. عقود العمليات التشغيلية ما زالت مصممة فقط وليست واجهات متاحة. راجع [دليل المرحلة 03](../phase-03-evidence.md) و[دليل المرحلة 04](../phase-04-evidence.md). هذه ملفات التكليف بالتنفيذ.
