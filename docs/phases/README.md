...
التنفيذ الفعلي: **المرحلتان 01 و02 منفذتان ومتحقق منهما محليًا ضمن نطاق التأسيس؛ مواصفات المرحلة 03 مكتملة؛ ومكونات/عرض المرحلة 04 التجريبي متحقق منها في Chromium مع انتظار مراجعة المالك؛ المرحلة 05 تنفذ أساس PostgreSQL والمعاملات الذرية ومتحقق منها بقاعدة فعلية؛ المرحلة 06 تنفذ عزل الشركات والفروع وصلاحيات المستخدمين ومتحقق منها بقاعدة PostgreSQL فعلية وهويات اختبار معلّمة؛ المرحلة 07 تنفذ الدخول والاستعادة والجلسات المنفصلة مع Keycloak وPostgreSQL وبريد محلي واختبارات متصفح فعلية؛ المرحلة 08 تنفذ تهيئة ERP بهوية خدمة موثقة ومراجعات مصدر وتسوية هوية خارج المعاملة مع اختبارات فعلية؛ المراحل 09–42 لم تبدأ، والمرحلة 09 هي التالية**. عقود العمليات التشغيلية ما زالت مصممة فقط وليست واجهات متاحة. راجع [دليل المرحلة 03](../phase-03-evidence.md) و[دليل المرحلة 04](../phase-04-evidence.md) و[دليل المرحلة 05](../phase-05-evidence.md) و[دليل المرحلة 06](../phase-06-evidence.md). راجع أيضًا [دليل المرحلة 07](../phase-07-evidence.md) و[طريقة التجربة](../identity.md)، و[دليل المرحلة 08](../phase-08-evidence.md) و[تجربة ERP العامة](../erp/consumer-quickstart.md). هذه ملفات التكليف بالتنفيذ.
