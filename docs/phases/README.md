...
التنفيذ الفعلي: **المراحل 01–13 منفذة ضمن حدود كل مرحلة؛ المرحلة 09 تضيف إدخال مهام الحساب المستقل بقاعدة PostgreSQL وواجهة عربية واختبار Chromium حقيقي، والمرحلة 10 تضيف استقبال شحنات ERP والاستلام والقبول الذري؛ المرحلة 11 منفذة محليًا ضمن حدود [دليل المواقع](../locations-and-maps.md)؛ المرحلة 12 نُفذت بمحولات مختبرة ببيانات محكومة مع عدم توفر Engine الحي؛ المرحلة 13 أضافت مهام تخطيط دائمة وتوقعات محفوظة مع اختبارات PostgreSQL وإعادة التشغيل؛ المرحلة 14 هي التالية**. العنوان المكتوب يحتاج تأكيد نقطة التوصيل؛ خرائط القاهرة الحقيقية متاحة محليًا وخدمة Nominatim الخاصة غير متاحة حاليًا. بقية عمليات التشغيل ما زالت مصممة فقط. راجع [سجل التنفيذ](../implementation-status.md)، [دليل المرحلة 11](../phase-11-evidence.md) و[طريقة تجربة الإدخال](../b2c-intake.md). هذه ملفات التكليف بالتنفيذ.
