...
التنفيذ الفعلي: **المرحلتان 01 و02 منفذتان ومتحقق منهما محليًا ضمن نطاق التأسيس؛ المراحل 03–42 لم تبدأ، والمرحلة 03 هي التالية**. عقود العمليات التشغيلية ما زالت مصممة فقط وليست واجهات متاحة. راجع [دليل المرحلة 02](../phase-02-evidence.md). هذه ملفات التكليف بالتنفيذ.
