...
**الحزمة الحالية: تعديل 3، تضم 42 مرحلة متتابعة تحت D-109–D-111، مع موديل ومستوى تفكير لكل مرحلة وتسليمات ERP محددة.**
التنفيذ الفعلي لكل المراحل: **لم يبدأ**. هذه ملفات التكليف بالتنفيذ.
...
- [خريطة القرارات](decision-map.md): تربط جميع القرارات D-01 إلى D-111 بالمتطلبات الحالية، وتوضح التعديلات التي تمنع تطبيق اقتراح قديم.
