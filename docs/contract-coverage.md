...
| `session.getContext` | http-read | designed | [P07](phases/07-oidc-login-recovery-sessions.md) | authenticated | Read subject, tenant, branches and effective capabilities. |
