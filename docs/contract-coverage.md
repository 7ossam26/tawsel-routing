...
| `sync.getEvidenceReceipt` | http-read | verified-local | [P34](phases/34-ordered-replay-conflict-recovery.md) | execution.own | Authenticated source/driver evidence and dynamically checked recovery constraints. A durable receipt is not business acceptance or an adoption permission. No P20 adoption endpoint. |
