...
The next execution prompt is [Phase 04 — representative UI review](phases/04-representative-ui-review.md). It may rely on the verified workspace/Phase 02 foundation and the Phase 03 design/action/state artifacts recorded below. Business operations remain designed; Phase 04 has not started.
